...
from spd.experiments.resid_mlp_2d.pairedresidualmlpdataset import PairedResidualMLPDataset
...
def run_train(config: ResidMLPTrainConfig, device: str) -> Float[Tensor, ""]:
    ...
    dataset = PairedResidualMLPDataset(
    n_features=model_cfg.n_features,
    feature_probability=config.feature_probability,
    device=device,
    pair_indices=config.pair_indices,
